...
INC = 
CFLAGS = -Wall -fexceptions -std=c++0x -g
RESINC = 
LIBDIR = 
LIB = -lpthread
LDFLAGS = 
...
DEP_DEBUG = 
OUT_DEBUG = bin/Debug/logsplitter
...
DEP_RELEASE = 
OUT_RELEASE = bin/Release/logsplitter

OBJ_DEBUG = $(OBJDIR_DEBUG)/main.o $(OBJDIR_DEBUG)/src/Configuration.o $(OBJDIR_DEBUG)/src/Core.o $(OBJDIR_DEBUG)/src/Item.o $(OBJDIR_DEBUG)/src/Writer.o

OBJ_RELEASE = $(OBJDIR_RELEASE)/main.o $(OBJDIR_RELEASE)/src/Configuration.o $(OBJDIR_RELEASE)/src/Core.o $(OBJDIR_RELEASE)/src/Item.o $(OBJDIR_RELEASE)/src/Writer.o
